...
final_text = encrypt_vigenere(plain_text, vigenere_matrix)
print("the encrypted text:",final_text[0])
print("the key:",final_text[1])
print("the decrypt:",decrypt_vigenere(final_text[0],vigenere_matrix,final_text[1]))


file = open("Encrypt.txt",'w')
file.write("Encrypted message is:"+ final_text[0])

file = open("Decrypt.txt",'w')
file.write("The decrypted  message is:"+plain_text)

file = open("Encrypt.txt",'w')
file.write("Encrypted message is:"+final_text[1])
